...
- **Editar durante la partida:** En **Acciones rápidas**, tocá **Editar escena** para abrir el editor táctil. En **Modo Dirección** podés arrastrar personajes sobre el escenario; desde **Fondo y personajes** podés cambiar el fondo y ajustar la composición antes de aplicar el cambio.
