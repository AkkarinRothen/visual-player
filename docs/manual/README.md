...
- **Cambios rápidos durante la partida:** En la pestaña **Sesión**, usá **Acciones rápidas** para activar con un toque **Relámpago**, **Sacudir**, **Cartel**, **Ambiente** y **Sonidos**. Tocá **Más** y luego **Herramientas de mesa** para abrir acciones secundarias como **Iluminación**, **Cámara y escena**, **Mostrar recurso** y **Música ambiental**. La hoja inferior se puede arrastrar hacia abajo, tocar afuera para cerrarla o elegir una acción.
